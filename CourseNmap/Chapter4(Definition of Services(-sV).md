...
4.Тут я увидел Программу: OpenSSH, Версию: 10.0, OC: Debian, и протокол: 2.0
5. Теперь вернемся в Wireshark, и заметим что сначало пошло подключение на проверку порта, после того как nmap проверил хост что он отвечает,
