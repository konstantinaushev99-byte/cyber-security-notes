...
3. ls -la - показывает все файлы и папки в текущей директории (включая скрытые) с подробной информацией
   ...
   - Пример вывода:
     ...
     drwxr-xr-x 2 vboxuser vboxuser 4096 Jun  8 10:00 01-networks
     drwxr-xr-x 2 vboxuser vboxuser 4096 Jun  8 10:00 02-network-implementation
     drwxr-xr-x 2 vboxuser vboxuser 4096 Jun  8 10:00 03-network-operations
